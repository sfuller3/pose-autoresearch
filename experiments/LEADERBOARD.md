...
Generated from `experiments/runs.jsonl` (3 runs logged). Regenerate with `python scripts/leaderboard.py`.

**Best so far:** `wide-30min` — val 0.9579, test 0.9590, checkpoint `checkpoints/best_model_wide-30min.pt`

| # | run | val | test | fall | eat | work | aggr | gait | wand | sit | channels | ep | min | params | rev |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | wide-30min | 0.9579 | 0.9590 | 0.979 | 0.956 | 0.968 | 0.944 | 0.945 | 0.951 | 0.971 | 192/192/384/384 | 95 | 30 | - | d35aef0+dirty |
| 2 | baseline-30min | 0.9536 | - | - | - | - | - | - | - | - | 128/128/256/256 | 95 | 30 | - | d35aef0+dirty |
| 3 | amp-ema-onecycle | 0.9487 | - | 0.978 | - | - | - | - | - | - | 128/128/256/256 | 60 | 15 | - | d35aef0 |
